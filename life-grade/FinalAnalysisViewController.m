...
- (void)addMethods {
    ...
    m2.description = @"Keeping lists can save lives! Seriously, just as your doctor, they survive on keeping well organized lists. When making your list make sure to organize, prioritize, and keep the items manageable and specific. This technique will keep you on task and";
    ...
    m3.description = @"Whether you like to admit or not, we all need reminders here and there. Use post-its, color coded paper, or whatever you can get your hands on to remind you that big things need to be happening! A reminder doesn’t mean you have a bad memory or that you are a bad person, it simply means you care about getting your stuff done.";
    ...
    m4.description = @"Sometimes emotions can get the best of us, so writing or blogging about your change can not only be therapeutic but can actually help you track your own thoughts and behaviors. Open up that notebook or computer of yours and starting getting those thoughts down!";
    ...
    m11.description = @"Life is driven by emotions and experiences. Whether it is with a group, one other person, or by yourself try to expand those healthy experiences by trying new things. Use this worksheet as a way to keep experiencing new hobbies and interests.";
    ...
    m12.description = @"Are you a midnight cereal eater, a fantasy football couch potato, or both? Fear not, you are making positive steps to change. Use these worksheets to organize your thoughts and actions to keep things manageable for yourself. Awareness is the first step and tracking your food and exercise will help guide you to a healthier you!";
    ...
    m15.description = @"Research shows that giving back outside of yourself and contributing is one sure fire way to experience fulfillment in life. A bucket list will gather the things you have always wanted to do, which will help add to your life’s fulfillment. Enjoy using this worksheet and adding serious value to your life";
    ...
    m16.description = @"Turn that frown upside down, well something like that. Positive thinking has a major impact on your happiness and the outcome of your goal. Let’s be honest, you can’t be positive all the time but you can try a counter some of that negative thinking with this handy worksheet. ";
